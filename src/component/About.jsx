...
// //                     <Button
// //                         variant="primary"
// //                         className='fade-in flex mx-auto items-center justify-center hover:scale-105 duration-300 rounded bg-gradient-to-b from-cyan-500 to-blue-500 lg:w-1/5 md:w-1/5 w-2/4 h-10 text-center cursor-pointer mt-10 gap-2'
// //                         data-aos="zoom-in"
...
//     return (
//         <div name="about" className='w-full h-auto bg-gradient-to-b from-gray-800 to-gray-900 text-white'>
//             <Container fluid className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-auto'>
//                 <Row className='pb-8'>
//                     <h2 className='text-4xl font-bold inline border-b-4 border-gray-500'>About</h2>
//                 </Row>
