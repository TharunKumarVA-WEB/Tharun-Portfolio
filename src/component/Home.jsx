            ...
            <div className='container-md'>
                <div className='row align-items-center justify-content-center'>
                    ...
                    <div className='col-md-6 text-center text-md-start'>
                        ...
                        As highly motivated individual who has self-transitioned into a Full Stack Developer specializing in the MERN stack, I aim to leverage my React and Node.js skills to contribute effectively to projects and continue building a valuable skill set in full stack development. 
                        </p>
